...
event_20 = Event.create!(user: juan, event_name: "It's a Pizza!", cuisine: "Italian", description: "Pizza is good here, join me for a food rampage!", restaurant_name: "Papa Pane di Sorrento", restaurant_address: "Ackerstraße 23, 10115 Berlin", restaurant_price_range: 2, start_time: DateTime.parse("13/03/2020 19:15"), end_time: DateTime.parse("13/03/2020 21:00"), spots: 5 )
