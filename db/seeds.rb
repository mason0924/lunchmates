...
event_16 = Event.create!(user: rahim, event_name: "Spring is coming, let's go South", cuisine: "Greek", description: "By warmer weather and sunnier days, a glass of wine with good Mediterranean food is perfect", restaurant_name: "Hinterhof", restaurant_address: "Chausseestraße 122, 10115 Berlin", restaurant_price_range: 3, start_time: DateTime.parse("13/03/2020 18:00"), end_time: DateTime.parse("13/03/2020 open"), spots: 6)
event_17 = Event.create!(user: kenny, event_name: "Tongue yoga", cuisine: "Vegan", description: "I found this restaurant called as the yoga practice. Join me for some chillier training!", restaurant_name:"Jivamukti", restaurant_address: "Brunnenstraße 29, 10119 Berlin", restaurant_price_range: 2, start_time: DateTime.parse("16/03/2020 17:30"), end_time: DateTime.parse("16/03/2020 19:30"), spots: 5)
event_18 = Event.create!(user: rosmah, event_name: "Going for some suhi, wanna join?", cuisine: "Japanese", description: "Join the neighborhood if in mood for fresh food", restaurant_name: "Aiko", restaurant_address: "Brunnenstraße 193, 10119 Berlin", restaurant_price_range: 2, start_time: DateTime.parse("13/03/2020 19:00"), end_time("13/03/2020 open"), spots: 6)
event_19 = Event.create!(user: mattia, event_name: "I'll be clear, we need Burgers and Beer, in here", cuisine: "Fast Food", description: "Fatty juicy Burgers, also vegetarian!", restaurant_name: "Tommis Burger Joint", restaurant_address: "Invalidenstraße 160, 10115 Berlin", restaurant_price_range: 2, start_time: DateTime.parse("13/03/2020 19:00"), end_time("13/03/2020 20:00"), spots: 3)
event_20 = Event.create!(user: mason, event_name: "It's a Pizza!", cuisine: "Italian", description: "Pizza is good here, join me for a food rampage!", restaurant_name: "Papa Pane di Sorrento", restaurant_address: "Ackerstraße 23, 10115 Berlin", restaurant_price_range: 2, start_time: DateTime.parse("13/03/2020 19:15"), end_time: DateTime.parse("13/03/2020 open"), spots: 5)
...
event_23 = Event.create!(user: azadeh, event_name: "Quick dinner before the party", cuisine: "European", description: "Let's get some food and first wine glasses before the party!", restaurant_name: "Factory Kitchen Berlin", restaurant_address: "Rheinsberger Str. 76/77, 10115 Berlin", restaurant_price_range: 2, start_time: DateTime.parse("13/03/2020 20:30"), end_time: DateTime.parse("13/03/2020 21:00") spots: 6)
