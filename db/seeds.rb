...
carmen = User.create!( first_name: "Carmen", last_name: "Rumor ", email:"carmen@gmail.com", password: "123456", profile: "Hola! Cumo esta! I'm from Barcelona! I'm studying organic make-up in Berlin. Would like to meet new people!")
...
event_25 = Event.create!(user: serenity, event_name: "Fancy Salad 🥗", cuisine: "Vegetarian", description: "Today is my cheat day. I want a salad 🥗", restaurant_name: "Diva Salad", restaurant_address: "Strelitzer Str. 60, 10115 Berlin", restaurant_price_range: 2, start_time: DateTime.parse("13/03/2020 20:30"), end_time: DateTime.parse("13/03/2020 21:00"), spots: 3 )
