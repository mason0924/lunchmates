...
katy = User.create!( first_name: "Katy", last_name: "Perry", email:"katy@gmail.com", password: "123456", profile: "From Australia with passion. Loving it here!")
ronald = User.create!( first_name: "Ronald", last_name: "Donald", email:"ronald@gmail.com", password: "123456", profile: "Despite the name, I don't like McDonald's. Let's get a Döner instead?")
...
=======
event_18 = Event.create!(user: rosmah, event_name: "Going for some suhi, wanna join?", cuisine: "Japanese", description: "Join the neighborhood if in mood for fresh food", restaurant_name: "Aiko", restaurant_address: "Brunnenstraße 193, 10119 Berlin", restaurant_price_range: 2, start_time: DateTime.parse("13/03/2020 19:00"), end_time: ("13/03/2020 21:00"), spots: 6 )
event_19 = Event.create!(user: mattia, event_name: "I'll be clear, we need Burgers and Beer, in here", cuisine: "Fast Food", description: "Fatty juicy Burgers, also vegetarian!", restaurant_name: "Tommis Burger Joint", restaurant_address: "Invalidenstraße 160, 10115 Berlin", restaurant_price_range: 2, start_time: DateTime.parse("13/03/2020 19:00"), end_time: ("13/03/2020 20:00"), spots: 3 )
>>>>>>> d86b5437b39ef0f3e99e5b32f99be1cdee2d0275
