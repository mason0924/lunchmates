...
event_NYC_2_Malay = Event.create!(user: felix, event_name: "Malaysian 🌶", cuisine: "Chinese", description: "Love spicy hot food especially Malaysian food!🔥", restaurant_name: "Nyonya", restaurant_address: "199 Grand St, New York, NY 10013", restaurant_price_range: 1, start_time: DateTime.parse("16/06/2021 12:30"), end_time: DateTime.parse("16/06/2021 14:30"), spots: 3 )
